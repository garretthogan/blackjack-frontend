    ...
    >
      ...
      <div className="absolute inset-2 overflow-hidden rounded-lg">
        <div
          ...
          style={{
            backgroundImage:"repeating-linear-gradient(45deg, rgba(255,255,255,0.08) 0 8px, transparent 8px 16px), repeating-linear-gradient(-45deg, rgba(255,255,255,0.08) 0 8px, transparent 8px 16px)",
          }}
        />

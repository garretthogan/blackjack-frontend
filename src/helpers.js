...
export const btnCls = "rounded-xl bg-stone-200 px-3 py-2 text-sm font-semibold text-stone-900 shadow-sm transition active:translate-y-px hover:bg-white";
export const btnAccent = "rounded-xl bg-emerald-400 px-3 py-2 text-sm font-semibold text-emerald-950 shadow-sm transition active:translate-y-px hover:bg-emerald-300";

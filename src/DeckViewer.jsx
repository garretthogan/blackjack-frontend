        ...
        <div style={containerStyle}>
            ...
            <div style={controlsStyle}>
                <input
                    ...
                    style={inputStyle}
                />
                <button style={btnStyle} onClick={sortByRank}>Sort by Rank</button>
                <button style={btnStyle} onClick={shuffle}>Shuffle</button>
                <button style={btnStyle} onClick={() => setQuery("")}>Clear Filter</button>
            </div>
    ...
    return (
        <div style={rowStyle}>
            <div style={{ ...miniCardStyle, color: isRed ? "#b00020" : "#111" }}>
                <div style={{ fontWeight: 700 }}>{card.rank}{card.suit}</div>
            </div>
            <div style={rowTextStyle}>
                <div style={{ fontWeight: 700 }}>{card.rank}{card.suit} — {card.suitName}</div>

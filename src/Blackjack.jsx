            ...
            {(stood || isBust) && (
                <div style={resultBoxStyle}>
                    ...
                    <div style={{ marginTop: 12, display: "flex", gap: 8, justifyContent: "center" }}>
                        <button style={btnStyle} onClick={startNewHand}>Next Hand</button>
                        <button style={btnStyle} onClick={() => navigate("/run-hub")}>Return to Hub</button>
                        <button style={btnStyle} onClick={() => { navigate('/bet') }}>Change Bet</button>
                    </div>
                </div>
            )}
